...
export default function ProjetoConexaoAnjoPage() {
  return (
      ...
      <section className="relative h-[80vh] w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="mx-4 rounded-3xl bg-black/40 p-8 text-center text-white backdrop-blur-xl ring-1 ring-white/10">
            <h1 className="mb-3 text-3xl font-bold md:text-5xl">HUMANITARIAN SUPPORT PLATFORM</h1>
            <h2 className="text-xl md:text-2xl">Conexão Anjo</h2>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl space-y-10 px-4 pb-20">
        <div>
          <h2 className="mb-2 text-2xl font-bold text-white">
            Estudo de Caso: Conexão Anjo — por ARC e FIAP
          </h2>
        </div>
        ...
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/90">
            Em resposta aos recentes desastres naturais que afetaram diversas regiões do Brasil,
            surgiu a necessidade de conectar, de forma rápida e acessível, pessoas em situação de
            vulnerabilidade a redes de apoio voluntário. O projeto Conexão Anjo foi idealizado com
            o propósito de oferecer ajuda humanitária direta, com foco em suporte emocional, doações
        ...
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/80">
            Durante eventos como enchentes, deslizamentos e queimadas, as vítimas frequentemente
            enfrentam dificuldades para localizar abrigos, centros de doação ou até mesmo acessar
            orientação básica. A ausência de uma plataforma centralizada limita a efetividade das
            ações voluntárias e deixa lacunas na comunicação entre quem precisa de ajuda e quem
            deseja ajudar.
          </p>
        </div>
        ...
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/80">
            O Conexão Anjo é um aplicativo mobile intuitivo que atua como ponte entre voluntários
            e pessoas afetadas. Por meio de um sistema geolocalizado e categorizado, a plataforma
            permite:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 pt-2 md:grid-cols-2">
          <div className="flex items-start gap-4 rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
            ...
            <div>
              <h4 className="mb-1 font-semibold">Interativo de Apoio</h4>
              <p className="text-sm text-white/80">
                Exibe abrigos, centros de doação e regiões mais afetadas com base em dados atualizados.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
            ...
            <div>
              <h4 className="mb-1 font-semibold">Canal de Apoio Emocional</h4>
              <p className="text-sm text-white/80">
                Oferece suporte psicológico inicial, com planos para integração com profissionais de saúde no futuro.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8">
          ...
          <ul className="space-y-1 pl-5 text-white/80 marker:text-white/60 list-disc">
            <li>Geolocalização para busca de suporte próximo.</li>
            <li>Chat de acolhimento com voluntários.</li>
            <li>Sistema de categorização de necessidades (roupa, comida, remédio, abrigo etc.).</li>
            <li>Interface inclusiva, com foco em acessibilidade.</li>
            <li>Backoffice para gestores e ONGs locais.</li>
          </ul>
        </div>
        ...
        <div className="px-4 py-24 text-white">
          ...
          <div className="flex flex-col gap-10 md:flex-row">
            ...
            <div className="space-y-12 text-sm text-white/85">
              <div>
                <h4 className="font-bold text-white">Conexão humanizada em momentos críticos</h4>
                <p>Acelera o contato entre vítimas e voluntários.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Apoio localizado e direcionado</h4>
                <p>Ajuda chega onde realmente é necessária, evitando desperdícios.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Acolhimento emocional</h4>
                <p>Um canal de escuta e suporte quando a estrutura emocional está abalada.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Expansível e adaptável</h4>
                <p>Pode ser replicado para diferentes tipos de desastres e regiões.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row">
          <div className="md:w-1/2">
            ...
            <p className="mt-8 text-white/85">
              O Conexão Anjo se mostrou uma ferramenta poderosa de mobilização social e resposta emergencial.
            </p>
            <p className="mt-8 text-white/85">
              Sua interface simples e funcional permitiu que centenas de usuários acessassem ajuda em poucos cliques.
            </p>
            <p className="mt-8 text-white/85">
              Além disso, facilitou a organização de voluntários e melhorou a eficiência da distribuição de recursos nas regiões afetadas.
            </p>
          </div>
          <div className="flex">
            <img src="mockupAnjo.png" alt="Mockup Conexão Anjo" width={300} />
          </div>
        </div>
      </section>
