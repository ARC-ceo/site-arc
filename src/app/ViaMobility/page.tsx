...
export default function ProjetoViaMobilityPage() {
  return (
      ...
      <section className="relative h-[80vh] w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="mx-4 rounded-3xl bg-black/40 p-8 text-center text-white backdrop-blur-xl ring-1 ring-white/10">
            <h1 className="mb-3 text-3xl font-bold md:text-5xl">URBAN MOBILITY INTELLIGENCE</h1>
            <h2 className="text-xl md:text-2xl">ViaMobility Platform</h2>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl space-y-10 px-4 pb-20">
        <div>
          <h2 className="mb-2 text-2xl font-bold text-white">
            Estudo de Caso: ViaMobility — por ARC, CCR e FIAP
          </h2>
        </div>

        {/* Cards de texto em vidro */}
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/90">
            A CCR, em parceria com a FIAP e o grupo ARC, identificou a necessidade de
            aprimorar a operação nas estações de metrô, melhorando a segurança, a fluidez
            e a experiência do usuário. Era preciso uma solução inteligente, capaz de
            monitorar e reagir em tempo real a situações críticas e operacionais.
          </p>
        </div>
        ...
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/80">
            Os sistemas tradicionais de controle de estações não ofereciam integração de dados
            em tempo real nem suporte para decisões rápidas. A operação dependia de múltiplas
            plataformas desconectadas, dificultando o monitoramento de fluxo, o registro de
            ocorrências e a gestão eficiente da operação.
          </p>
        </div>
        ...
        <div className="rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
          ...
          <p className="text-white/80">
            O ViaMobility é uma plataforma digital que integra sensores, visão computacional e
            dashboards inteligentes para otimizar o gerenciamento das estações. A solução foi
            desenvolvida com foco em escalabilidade, usabilidade e integração operacional.
          </p>
        </div>

        {/* Features (cards de item) */}
        <div className="grid grid-cols-1 gap-6 pt-2 md:grid-cols-2">
          <div className="flex items-start gap-4 rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
            ...
            <div>
              <h4 className="mb-1 font-semibold">Dashboard Inteligente</h4>
              <p className="text-sm text-white/80">
                Interface central com dados em tempo real, filtros avançados e KPIs operacionais
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-3xl bg-white/5 p-6 text-white backdrop-blur-xl ring-1 ring-white/10">
            ...
            <div>
              <h4 className="mb-1 font-semibold">Módulo de Ocorrências</h4>
              <p className="text-sm text-white/80">
                Registro, categorização e acompanhamento completo de incidentes operacionais.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8">
          ...
          <ul className="space-y-1 pl-5 text-white/80 marker:text-white/60 list-disc">
            <li>Monitoramento em tempo real da operação.</li>
            <li>Alertas automáticos e notificações.</li>
            <li>Gestão de ocorrências com histórico e acompanhamento.</li>
            <li>Visualização de métricas estratégicas.</li>
            <li>Conectividade com APIs externas (clima, transporte, tráfego).</li>
          </ul>
        </div>
        ...
        <div className="px-4 py-24 text-white">
          ...
          <div className="flex flex-col gap-10 md:flex-row">
            ...
            <div className="space-y-12 text-sm text-white/85">
              <div>
                <h4 className="font-bold text-white">Decisões rápidas e assertivas</h4>
                <p>Dados precisos permitem respostas imediatas a situações críticas.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Melhoria da experiência do passageiro</h4>
                <p>Orientações mais claras, redução de atrasos e comunicação eficiente.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Controle e planejamento estratégico</h4>
                <p>Relatórios e métricas que apoiam melhorias contínuas da operação.</p>
              </div>
              <div>
                <h4 className="font-bold text-white">Escalável e personalizável</h4>
                <p>Pronto para ser implementado em novas estações e sistemas.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row">
          <div className="md:w-1/2">
            ...
            <p className="mt-8 text-white/85">
              A implantação do ViaMobility resultou em maior controle operacional, melhoria da
              segurança e aumento da satisfação dos usuários. A plataforma reduziu o tempo de
              resposta a ocorrências, otimizou o fluxo de passageiros e elevou o padrão de
              inteligência urbana nas estações atendidas pela CCR.
            </p>
            <p className="mt-8 text-white/85">
              A plataforma reduziu o tempo de resposta a ocorrências, otimizou o fluxo de
              passageiros e elevou o padrão de inteligência urbana nas estações atendidas pela CCR.
            </p>
          </div>
          <div className="flex">
            <img src="moldura VM 1.png" alt="Moldura do ViaMobility" width={200} />
          </div>
        </div>
      </section>
