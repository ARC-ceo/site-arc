        ...
        <div>
            <footer className="py-6 px-12 flex flex-row justify-between items-center">
                ...
                <div className="flex">
                    ...
                    <Link href="https://github.com/arc-CEO" target="_blank" rel="noopener noreferrer"><img src="iconegithub.png" className="w-9"/></Link>
                    <Link href="https://www.instagram.com/arc_grupo/" target="_blank" rel="noopener noreferrer"><img src="iconeig.png" className="w-9"/></Link>
                </div>
            </footer>      
        </div>
    );
